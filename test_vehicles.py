...
def animate(frame_number):
	...
	def update(vehicle, t_start, coords, center, trajectory, arrow):
	...
	# def update(vehicle, center, trajectory):
		# # update the center and trajectory of the vehicle
		# center.set_data(vehicle.position[1], vehicle.position[0])

		# trajectory.set_data(vehicle.position_history[:vehicle.step_counter, 1],
								 # vehicle.position_history[:vehicle.step_counter, 0])
		# return center, trajectory
		
	return (update(vehicle_1, t_start, coords_1, center_1, trajectory_1, arrow_1) 
	    + update(vehicle_2, t_start, coords_2, center_2, trajectory_2, arrow_2)) + (time_text,)
